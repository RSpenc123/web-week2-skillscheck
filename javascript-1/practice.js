...
// Code Here
let doubled = myNumbers.map((element, index, array) => {
	return element *2
  })
//////////////////PROBLEM 15////////////////////
...
// Code Here
let filtered = myNumbers.filter((element,index,array) => {
	return element > 100})
...
// Code Here
let total = myNumbers.reduce((total,element,index,array) =>{
...
// Code Here
let enemies = []
people.filter(function(element,index, array){
...
awesome.push(element.awesomeLevel)
})

var totallyAwesome = 0
awesome.reduce((total,element, index, array) => {
	  totallyAwesome =total+element 
